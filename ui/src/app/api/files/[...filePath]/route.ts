...
export async function GET(request: NextRequest, { params }: { params: Promise<{ filePath: CatchAllPathParam }> }) {
  ...
  try {
    ...
    const resolvedFilePath = resolveAllowedCatchAllPath(filePath, allowedDirs);
